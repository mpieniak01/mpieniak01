...
| `virt-manager/virt-manager` | 66 | 99926 | 3116 | Python | Desktop tool for managing virtual machines via libvirt |
...
| `khoj-ai/khoj` | 40 | 117335 | 34194 | Python | Your AI second brain. Self-hostable. Get answers from the web or your docs. Build custom agents, schedule automations, do deep research. Turn any online or local LLM into your personal, autonomous AI (gpt, claude, gemini, llama, qwen, mistral). Get started - free. |
