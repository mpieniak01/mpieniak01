...
def _run_timeseries_mode(
    ...
    *,
    ...
    raw_dir = ts_root / "raw"
    csv_dir = ts_root / "csv"
    agg_csv_path = ts_root / "205B_timeseries_q1_2026.csv"
    ...
    lines: list[str] = []
    lines.append("# 205B_analiza_sonar_benchmark_rynek_timeseries")
    lines.append("")
...
def _write_markdown(
    ...
    *,
    ...
    lines: list[str] = []
    lines.append("# 205B_analiza_sonar_benchmark_rynek")
    lines.append("")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-json",
        default="docs_dev/_to_do/205_artifacts/205B/analysis/205B_analiza_sonar_benchmark_rynek.json",
        help="Output JSON path.",
    )
    parser.add_argument(
        "--output-md",
        default="docs_dev/_to_do/205_artifacts/205B/analysis/205B_analiza_sonar_benchmark_rynek.md",
    ...
    parser.add_argument(
        "--timeseries-dir",
        default="docs_dev/_to_do/205_artifacts/205B/timeseries",
