...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--dataset-id",
        default="",
        help="Dataset identifier from config.process.steps (default: github_market).",
    )
    ...
    p.add_argument("--per-repo-dir", default="")
    return p.parse_args()
...
def main() -> int:
    ...
    script_cfg = cfg_get(cfg, "scripts", "github_market_benchmark", default={}) or {}
    ...
    args.repo_file = resolve_dataset_path(
        repo_root,
        cfg,
        dataset_id,
        "repo_file",
        args.repo_file,
        script_cfg,
        "artifacts/inputs/github_market/repo_keys_selected_v01.txt",
        for_input=True,
    )
    args.selection_json = resolve_dataset_path(
        repo_root,
        cfg,
        dataset_id,
        "selection_json",
        args.selection_json,
        script_cfg,
        "artifacts/sources/github_market/repo_selection_v01.json",
    )
    args.selection_md = resolve_dataset_path(
        repo_root,
        cfg,
        dataset_id,
        "selection_md",
        args.selection_md,
        script_cfg,
        "artifacts/sources/github_market/repo_selection_v01.md",
    )
    args.selection_keys = resolve_dataset_path(
        repo_root,
        cfg,
        dataset_id,
        "selection_keys",
    ...
    args.output_json = resolve_dataset_path(
        ...
        args.output_json,
        script_cfg,
        "artifacts/products_light/github_market/benchmark_analysis_2026_v01.json",
    )
    args.output_md = resolve_dataset_path(
        ...
        args.output_md,
        script_cfg,
        "artifacts/products_light/github_market/benchmark_analysis_2026_v01.md",
    )
    ...
    args.per_repo_dir = resolve_dataset_path(
        repo_root,
        cfg,
        dataset_id,
        "per_repo_dir",
