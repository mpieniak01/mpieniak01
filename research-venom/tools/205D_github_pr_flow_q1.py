...
def run(args: argparse.Namespace) -> int:
    ...
    agg_path = root / "205D_pr_flow_q1_2026.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--owner", default="mpieniak01")
    p.add_argument("--repo", default="Venom")
    ...
    p.add_argument(
        "--output-root", default="docs_dev/_to_do/205_artifacts/205D/timeseries"
    )
    p.add_argument(
        "--output-json",
        default="docs_dev/_to_do/205_artifacts/205D/analysis/205D_analiza_pr_flow_q1_2026.json",
    )
    p.add_argument(
        "--output-md",
        default="docs_dev/_to_do/205_artifacts/205D/analysis/205D_analiza_pr_flow_q1_2026.md",
    )
    return p.parse_args()
